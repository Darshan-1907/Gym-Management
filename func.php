...
if(isset($_POST['pat_submit']))
{
    ...
    if(isset($_POST['tra_submit']))
    {
        ...
        if(isset($_POST['pay_submit']))
        {
            ...
            $contact=$_POST['contact'];
            $query="insert into Payment(Payment_id,Amount,customer_id,payment_type,customer_name,contact)values('$Payment_id','$Amount','$customer_id','$payment_type','$customer_name','$contact')";
             $result=mysqli_query($con,$query);
            if($result)
            {
